                    ...
                    <div class="col-md-12 landing">
                        <form action="<?php echo base_url();?>Peserta/save_registrasi" method="post" class="form-peserta">
                            <div class="group" style="margin-top: 10px;">
                                <input type="text" class="input-md" id="input-peserta2" name="nama_peserta" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nama Peserta</label>
                            </div>
                            <div class="group">
                                <input type="text" class="input-md" id="input-peserta2" name="email">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Email</label>
                            </div>
                            <div class="group">
                                <input type="text" class="input-md" id="input-peserta2" name="no_hp">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nomor HP</label>
                            </div>
                            <div class="group">
                                <select class="input-md" id="input-peserta2" name="asal_sekolah">
                            ...
                            <div class="group">
                                <input type="text" class="input-md" id="input-peserta2" name="kelas">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Kelas</label>
                            </div>
                            <button type="submit" class="btn btn-submit btn-peserta2">
                            Submit
                            </button>
                        </form>
